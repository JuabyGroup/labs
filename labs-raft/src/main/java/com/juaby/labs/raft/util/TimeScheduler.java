 ...
 * method {@link com.juaby.labs.raft.util.TimeScheduler.Task#nextInterval()} needs to be implemented.
 * </ul>
 *
 * @author Bela Ban
 */
public interface TimeScheduler {
     ...
     * ({@link TimeScheduler#scheduleWithDynamicInterval(com.juaby.labs.raft.util.TimeScheduler.Task)}) must implement
     */
     ...
     * {@link com.juaby.labs.raft.util.TimeScheduler.Task#nextInterval()} milliseconds. This is delay-based and not
     * rate-based.
