...
public class RpcTraceClassVisitor extends ClassVisitor {
     ...
     */
    public RpcTraceClassVisitor(final ClassVisitor cv, final RpcPrint p,
    ...
    public AnnotationVisitor visitAnnotation(final String desc,
        ...
        RpcPrint p = this.p.visitClassAnnotation(desc, visible);
    ...
    public AnnotationVisitor visitTypeAnnotation(int typeRef,
        ...
        RpcPrint p = this.p.visitClassTypeAnnotation(typeRef, typePath, desc,
                visible);
    ...
    public FieldVisitor visitField(final int access, final String name,
        ...
        RpcPrint p = this.p.visitField(access, name, desc, signature, value);
    ...
    public MethodVisitor visitMethod(final int access, final String name,
        ...
        RpcPrint p = this.p.visitMethod(access, name, desc, signature,
                exceptions);
