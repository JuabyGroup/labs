 ...
 */
public class RpcCallbackProxyJGenerator extends ClassLoader implements Opcodes {

    public RpcCallbackProxyJGenerator() {
        super(RpcCallbackProxyJGenerator.class.getClassLoader());
    }
