 ...
 */
public class RpcTextifier extends RpcPrint {
    ...
    /**
     * Constructs a new {@link RpcTextifier}. <i>Subclasses must not use this
     * constructor</i>. Instead, they must use the {@link #RpcTextifier(int)}
     * version.
     *
    ...
    public RpcTextifier() {
        this(Opcodes.ASM5);
        if (getClass() != RpcTextifier.class) {
            throw new IllegalStateException();
        }
    }

    /**
     * Constructs a new {@link RpcTextifier}.
     *
     * @param api
     *            the ASM API version implemented by this visitor. Must be one
     *            of {@link Opcodes#ASM4} or {@link Opcodes#ASM5}.
     */
    protected RpcTextifier(final int api) {
        super(api);
    }
     ...
     * <p>
     * Usage: RpcTextifier [-debug] &lt;binary class name or class file name &gt;
     *
     * @param args
    ...
    public static void main(final String[] args) throws Exception {
        ...
        if (!ok) {
            ...
            System.err.println("Usage: RpcTextifier [-debug] "
    ...
    @Override
    public RpcTextifier visitClassAnnotation(final String desc,
    ...
    @Override
    public RpcPrint visitClassTypeAnnotation(int typeRef, TypePath typePath,
    ...
    @Override
    public RpcTextifier visitField(final int access, final String name,
        ...
        RpcTextifier t = createTextifier();
        text.add(t.getText());
        return t;
    }

    @Override
    public RpcTextifier visitMethod(final int access, final String name,
    ...
    @Override
    public RpcTextifier visitAnnotation(final String name, final String desc) {
        buf.setLength(0);
        appendComa(valueNumber++);
        if (name != null) {
            buf.append(name).append('=');
    ...
    @Override
    public RpcTextifier visitArray(final String name) {
        buf.setLength(0);
        appendComa(valueNumber++);
        if (name != null) {
            buf.append(name).append('=');
    ...
    @Override
    public RpcTextifier visitFieldAnnotation(final String desc,
                                          final boolean visible) {
        return visitAnnotation(desc, visible);
    }

    @Override
    public RpcPrint visitFieldTypeAnnotation(int typeRef, TypePath typePath,
                                            String desc, boolean visible) {
        return visitTypeAnnotation(typeRef, typePath, desc, visible);
    }
    ...
    @Override
    public RpcTextifier visitAnnotationDefault() {
    ...
    @Override
    public RpcTextifier visitMethodAnnotation(final String desc,
                                           final boolean visible) {
        return visitAnnotation(desc, visible);
    }

    @Override
    public RpcPrint visitMethodTypeAnnotation(int typeRef, TypePath typePath,
                                             String desc, boolean visible) {
        return visitTypeAnnotation(typeRef, typePath, desc, visible);
    }

    @Override
    public RpcTextifier visitParameterAnnotation(final int parameter,
    ...
    @Override
    public RpcPrint visitInsnAnnotation(int typeRef, TypePath typePath,
                                       String desc, boolean visible) {
        return visitTypeAnnotation(typeRef, typePath, desc, visible);
    }
    ...
    @Override
    public RpcPrint visitTryCatchAnnotation(int typeRef, TypePath typePath,
                                           String desc, boolean visible) {
        buf.setLength(0);
        buf.append(tab2).append("TRYCATCHBLOCK @");
        appendDescriptor(FIELD_DESCRIPTOR, desc);
     ...
     */
    public RpcTextifier visitAnnotation(final String desc, final boolean visible) {
        buf.setLength(0);
     ...
     * @return a visitor to visit the annotation values.
     */
    public RpcTextifier visitTypeAnnotation(final int typeRef,
     ...
     */
    protected RpcTextifier createTextifier() {
        return new RpcTextifier();
    }
